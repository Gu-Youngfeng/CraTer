...
//		CLSAnalyzer clsr = new CLSAnalyzer("E:/Datasets/Lang/Lang/lang_1_buggy/", "org.apache.commons.lang3.math.NumberUtils");		
		CLSAnalyzer clsr = new CLSAnalyzer("E:/Datasets/Lang/Lang/lang_65_buggy/", "org.apache.commons.lang.ArrayUtils");		
...
//			System.out.println("[outer class]: " + OuterName + " [inner class]: " + InnerName);
			...
			if(!new File(fullClass).exists()){
				fullClass = proj + "src/java/" + OuterName.replaceAll("\\.", "/") + ".java";
			}
