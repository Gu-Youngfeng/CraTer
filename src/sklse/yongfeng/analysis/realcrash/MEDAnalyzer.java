...
public class MEDAnalyzer {
	...
	public static void main(String[] args) {
		MEDAnalyzer iii;
		try {
//			iii = new MEDAnalyzer("E:/Datasets/Lang/Lang/lang_1_buggy/", "org.apache.commons.lang3.math.NumberUtils", "toInt", 122);
			iii = new MEDAnalyzer("E:/Datasets/Lang/Lang/lang_65_buggy/", "org.apache.commons.lang.ArrayUtils", "toMap", 240);
			iii.showMEDFeatures();
		} catch (Exception e) {
...
//			System.out.println("[inner]:" + innerClass);
			...
			if(!new File(fullClass).exists()){
				fullClass = proj + "src/java/" + clsName.replaceAll("\\.", "/") + ".java";
			}
