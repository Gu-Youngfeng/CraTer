...
//						
	...
	/**
	 * <p>To obtain the label of single crash (i-th).</p>
	 * @param lsCrash crash list
	 * @param i index
	 */
	public static void getLabels(List<CrashNode> lsCrash, int i){ 
		
		String label = lsCrash.get(i).InTrace >= 0?"InTrace":"OutTrace";
	 ...
	 * @throws Exception
	 */
	public static void getFeatures(List<CrashNode> lsCrash, String proj, int i){
